...
ctx.lineWidth= 5;
ctx.arc(256, 207, 40, 0, 2*Math.PI);
ctx.stroke();
...
ctx.strokeStyle= "grey";
ctx.lineWidth= 1;
ctx.rect(182, 364, 430, 200);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle= "black";
ctx.lineWidth= 5;
ctx.arc(261, 443, 40, 0, 2*Math.PI);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle= "black";
ctx.lineWidth= 5;
ctx.arc(325, 435, 40, 0, 2*Math.PI);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle= "black";
ctx.lineWidth= 5;
ctx.arc(374, 430, 40, 0, 2*Math.PI);
ctx.stroke();

ctx.beginPath();
ctx.strokeStyle= "black";
ctx.lineWidth= 5;
ctx.arc(430, 432, 40, 0, 2*Math.PI);
ctx.stroke();

document.getElementById("name").innerHTML="Olympic and Audi Symbol have circles"
}
